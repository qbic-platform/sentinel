...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to qbicd "gobject list" output
    ...
    def qbicd_serialise(self):
        import qbiclib
        return qbiclib.SHIM_serialise_for_qbicd(self.serialise())
